    ...
    const getSvg = () => {
        ...
        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 560">
            <g id="svgPath">
                ...
                <text x="50%" y="530" style="font-size: 120px; text-anchor: middle; font-family: monospace; font-weight: bold; filter: drop-shadow(0px 0px 4px rgb(0 0 0 / 1.0));" fill="white">${busDetails.vehicleId}-${busDetails.direction[0]}</text>
            </g>
        </svg>
        `;
